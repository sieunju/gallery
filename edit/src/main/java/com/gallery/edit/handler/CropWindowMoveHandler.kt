 ...
 * Description :
 *
 * Created by juhongmin on 2022/10/09
 */
class CropWindowMoveHandler(
    ...
    private var mMinCropWidth = cropWindowHandler.getMinCropWidth()

    /** Minimum width in pixels that the crop window can get.  */
    private var mMinCropHeight = cropWindowHandler.getMinCropHeight()

    /** Maximum height in pixels that the crop window can get.  */
    private var mMaxCropWidth = cropWindowHandler.getMaxCropWidth()

    /** Maximum height in pixels that the crop window can get.  */
    private var mMaxCropHeight = cropWindowHandler.getMaxCropHeight()
